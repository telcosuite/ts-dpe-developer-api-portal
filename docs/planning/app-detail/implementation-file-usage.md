# Developer And API Portal Implementation File Usage

Reviewed: 2026-06-14

## Purpose

Use this guide when building `Developer And API Portal`. It explains which generated files matter, when to read them, and how they drive Angular, Spring Boot, PostgreSQL, TMF API, event, and privacy work.
...
| Primary APIs | TMF720, TMF672, TMF668, TMF704, TMF706, TMF705, TMF628, TMF657, TMF708, TMF707, TMF710 |
| Starter tables | 9 |
...
| App overview | [../developer-api-portal.md](../developer-api-portal.md) | Concise product scope, app purpose, TMF API usage, ownership, integrations, and first-release direction. |
...
| App TMF review | [../../tmf-api-ddl-reviews/developer-api-portal.md](../../tmf-api-ddl-reviews/developer-api-portal.md) | TMF APIs, resource-to-table mapping, field handling, event baseline, privacy/retention/audit baseline. |
...
| App V002+ migration | [../../../../database/postgres/suites/ts_digital_partner_ecosystem/V002__refine_developer_api_portal_tmf_core.sql](../../../../database/postgres/suites/ts_digital_partner_ecosystem/V002__refine_developer_api_portal_tmf_core.sql) | Promotes common TMF columns and creates app support tables, event_contract, and privacy_retention_policy. |
...
9. Use `developer_api_portal.event_contract` as the baseline event register and `developer_api_portal.event_outbox` for publication.
10. Use `developer_api_portal.privacy_retention_policy` as the baseline for masking, audit, retention, legal hold, and residency handling.
...
- Write only inside schema `developer_api_portal` for this app's operational data.
